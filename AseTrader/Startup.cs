    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddAuthentication()
                ...
                .AddFacebook(options =>
                {
                    options.AppId = "182773716278040"; //Configuration["Authentication:Facebook:AppId"];
                    options.AppSecret = "0ff7415188f20cdccc13abf9a7e08437"; //Configuration["Authentication:Facebook:AppSecret"];
                })
                .AddTwitter(options =>
                {
                    options.ConsumerKey = "182773716278040"; //Configuration["Authentication:Twitter:ClientId"];
                    options.ConsumerSecret = "0ff7415188f20cdccc13abf9a7e08437"; //Configuration["Authentication:Twitter:ClientSecret"];
                })
